...
contract CreditScoreDB {
    bool public isInitialized; // Whether the contract has been initialized
    ...
    /**
     * @dev Initializes the database
     * @param _owner Address of the owner of this database
     * @param _authority Address of the authority smart contract
     */
    function initialize(address _owner, address _authority) public {
        isInitialized = true;
        owner = _owner;
